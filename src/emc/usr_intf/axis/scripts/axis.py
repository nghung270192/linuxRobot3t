...
widgets = nf.Widgets(root_window, 
    ...
    ("joint_1", Radiobutton, axes_conntrol + ".joints.joint1"),
    ("joint_2", Radiobutton, axes_conntrol + ".joints.joint2"),
    ("joint_3", Radiobutton, axes_conntrol + ".joints.joint3"),
    ("joint_4", Radiobutton, axes_conntrol + ".joints.joint4"),
    ("joint_5", Radiobutton, axes_conntrol + ".joints.joint5"),
    ("joint_6", Radiobutton, axes_conntrol + ".joints.joint6"),
    ("joint_7", Radiobutton, axes_conntrol + ".joints.joint7"),
    ("joint_8", Radiobutton, axes_conntrol + ".joints.joint8"),
    ("joint_9", Radiobutton, axes_conntrol + ".joints.joint9"),
