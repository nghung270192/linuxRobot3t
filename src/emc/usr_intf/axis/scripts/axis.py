...
frame_setting = str(root_window.tk.call("set", "frame_setting"))
widgets = nf.Widgets(root_window, 
    ...
    ("settext", Label, axes_conntrol + ".axes1.axiswtxt"),

    ("joints", Button, axes_conntrol + ".joint1s"),
    ("joint_0", Button, axes_conntrol + ".joint1s.joint0"),
    ("joint_1", Button, axes_conntrol + ".joint1s.joint1"),
    ("joint_2", Button, axes_conntrol + ".joint1s.joint2"),
    ("joint_3", Button, axes_conntrol + ".joint1s.joint3"),
    ("joint_4", Button, axes_conntrol + ".joint1s.joint4"),
    ("joint_5", Button, axes_conntrol + ".joint1s.joint5"),
    ("joint_6", Button, axes_conntrol + ".joint1s.joint6"),
    ("joint_7", Button, axes_conntrol + ".joint1s.joint7"),
    ("joint_8", Button, axes_conntrol + ".joint1s.joint8"),
    ("joint_9", Button, axes_conntrol + ".joint1s.joint9"),

    ("jogincr", Entry, axes_conntrol + ".jogf.jog.jogincr"),
    ("override", Checkbutton, axes_conntrol + ".jogf.override"),

    ("ajogspeed", Entry, frame_setting + ".ajogspeed"),

    ("lubel", Label, axes_conntrol + ".coolant"),
    ("flood", Checkbutton, axes_conntrol + ".flood"),
    ("mist", Checkbutton, axes_conntrol + ".mist"),

    ("brake", Checkbutton, axes_conntrol + ".spindlef.brake"),

    ("spindlel", Label, axes_conntrol + ".spindlel"),
    ("spindlef", Frame, axes_conntrol + ".spindlef"),
    ("spindle_ccw", Radiobutton, axes_conntrol + ".spindlef.ccw"),
    ("spindle_stop", Radiobutton, axes_conntrol + ".spindlef.stop"),
    ("spindle_cw", Radiobutton, axes_conntrol + ".spindlef.cw"),

    ("spindle_minus", Button, axes_conntrol + ".spindlef.spindleminus"),
    ("spindle_plus", Button, axes_conntrol + ".spindlef.spindleplus"),
    ...
    ("feedoverride", Scale, frame_setting + ".feedoverride.foscale"),
    ("rapidoverride", Scale, frame_setting + ".rapidoverride.foscale"),
    ("spinoverride", Scale, frame_setting + ".spinoverride.foscale"),
    ("spinoverridef", Scale, frame_setting + ".spinoverride"),
    ...
    ("homebutton", Button, axes_conntrol + ".jogf.zerohome.home"),
...
class TclCommands(nf.TclCommands):
    ...
    def set_text1(event=None):
            widgets.settext.configure(textvariable=_("Nguyen Hung"))
...
root_window.tk.eval("${frame_setting}.jogspeed.s set [setval $jog_speed $max_speed]")
root_window.tk.eval("${frame_setting}.ajogspeed.s set [setval $jog_aspeed $max_aspeed]")
root_window.tk.eval("${frame_setting}.maxvel.s set [setval $maxvel_speed $max_maxvel]")
...
if lu == 1:
    root_window.tk.eval("${frame_setting}.jogspeed.l1 configure -text mm/min")
    root_window.tk.eval("${frame_setting}.maxvel.l1 configure -text mm/min")
else:
    root_window.tk.eval("${frame_setting}.jogspeed.l1 configure -text in/min")
    root_window.tk.eval("${frame_setting}.maxvel.l1 configure -text in/min")
root_window.tk.eval(u"${frame_setting}.ajogspeed.l1 configure -text deg/min")
